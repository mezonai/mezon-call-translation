...
def upgrade() -> None:
    ...
    op.create_index('ix_tracks_participant_identity', 'tracks', ['participant_identity'], unique=False)
    ...
    op.create_index('ix_chunks_track_chunk_index', 'transcript_chunks', ['track_ref_id', 'chunk_index'], unique=False)

    # rooms_summary
    op.create_table('rooms_summary',
        sa.Column('id', sa.Text(), nullable=False),
    ...
    # metadata_events
    op.create_table('metadata_events',
        sa.Column('id', sa.Text(), nullable=False),
