...
class BaseHashRepository:
    ...
    async def set(self, hash_key: str, stats_key: str | None, key: str, value: str) -> bool:
        ...
        try:
            ...
            logger.info(f"[{self.__class__.__name__}] Set '{key}' = '{value}'")
            return True
    ...
    async def set_overwrite(self, hash_key: str, stats_key: str | None, key: str, value: str) -> None:
    ...
    async def delete(self, hash_key: str, stats_key: str | None, key: str) -> bool:
        ...
        try:
            ...
            logger.error(f"[{self.__class__.__name__}] Failed to delete '{key}': {e}")
            raise
