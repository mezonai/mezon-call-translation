...
async def api_create_dispatch(body: DispatchRequestModel) -> DispatchActionResponseModel:
...
async def api_cancel_dispatch(body: DispatchRequestModel) -> DispatchActionResponseModel:
