"""
Speech-to-Text WebSocket Client - Nemotron transcription service

This client handles audio streaming to Nemotron transcription server
...
class STTWebSocketClient(BaseWebSocketClient):
    ...
    def __init__(
        ...
        # Build WebSocket URL
        url = (
            f"ws://{self.config.host}:{self.config.port}/ws/nemotron/"
