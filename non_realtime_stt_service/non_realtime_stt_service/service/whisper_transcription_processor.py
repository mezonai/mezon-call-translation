...
from non_realtime_stt_service.service.redis.redis_producer_service import RedisProducerService
from non_realtime_stt_service.service.whisper_marker_transcriber import (
...
from non_realtime_stt_service.models import TranscriptionStreamTask, SaveTranscriptionTask
...
class WhisperTranscriptionProcessor:
    ...
    def __init__(self):
        ...
        self.CHUNK_BATCH_SIZE = getattr(self._config, "transcript", getattr(self._config, "Transcirpt", None)).chunk_size
    ...
    async def initialize(self):
        ...
        self._marker_transcriber = MarkerWhisperTranscriber(
            ...
            gipformer_model_path=whisper_config.gipformer_model_path,
